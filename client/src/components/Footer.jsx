        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Advanced security monitoring and threat detection for modern applications.<br/> 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/alerts" className="text-gray-400 hover:text-white transition-colors">Security Alerts</Link>
              </li>
              <li>
                <Link to="/reports" className="text-gray-400 hover:text-white transition-colors">Reports</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Security Blog</a>
              </li>
              <li>
